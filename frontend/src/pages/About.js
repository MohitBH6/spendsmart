      ...
      <div style={{ padding: '32px 48px', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={styles.card}>
          ...
          <p style={styles.appDesc}>
            SpendSmart is a full-stack personal finance tracker that helps you log daily expenses,
            set monthly budgets per category, and get smart insights about your spending patterns.
            It automatically detects when you're approaching your budget limits and alerts you
        ...
        <div style={styles.card}>
          ...
          <div style={styles.featGrid}>
            {[
              ...
              { icon: '📝', title: 'Expense Tracking', desc: 'Add, view, and delete expenses with amount, category, description, and date.' },
        ...
        {/* How to use + Tech Stack side by side */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }}>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.techGrid}>
              {[
                { layer: 'Frontend', tech: 'React.js, Chart.js, React Router, Axios' },
                { layer: 'Backend', tech: 'Python, Flask, Flask-JWT-Extended, Flask-CORS' },
                { layer: 'Database', tech: 'SQLite with SQLAlchemy ORM' },
                { layer: 'Analytics', tech: 'Pandas, NumPy (anomaly detection)' },
                { layer: 'Auth', tech: 'JWT tokens, Werkzeug password hashing' },
                { layer: 'Deployment', tech: 'Render (backend) + Vercel (frontend)' },
              ].map((t, i) => (
                <div key={i} style={styles.techRow}>
                  <span style={styles.techLayer}>{t.layer}</span>
                  <span style={styles.techVal}>{t.tech}</span>
                </div>
              ))}
            </div>
          </div>
...
const styles = {
  ...
  appName: { fontSize: '24px', fontWeight: '700', color: '#534AB7', margin: 0 },
  appTagline: { fontSize: '14px', color: '#888', margin: 0 },
  appDesc: { fontSize: '14px', color: '#555', lineHeight: '1.7' },
  sectionTitle: { fontSize: '16px', fontWeight: '600', color: '#1a1a1a', marginBottom: '20px' },
  featGrid: {
    display: 'grid',
  ...
  featIcon: { fontSize: '22px', flexShrink: 0, marginTop: '2px' },
  featTitle: { fontSize: '13px', fontWeight: '600', color: '#1a1a1a', marginBottom: '4px' },
  featDesc: { fontSize: '12px', color: '#666', lineHeight: '1.5' },
  stepRow: { display: 'flex', gap: '14px', alignItems: 'flex-start', marginBottom: '16px' },
  stepNum: {
    width: '28px', height: '28px', borderRadius: '50%',
    background: '#534AB7', color: '#fff', fontSize: '13px', fontWeight: '600',
    display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
  },
  stepTitle: { fontSize: '14px', fontWeight: '600', color: '#1a1a1a', marginBottom: '3px' },
  stepDesc: { fontSize: '13px', color: '#666', lineHeight: '1.5' },
  techGrid: { display: 'flex', flexDirection: 'column' },
  techRow: {
    display: 'flex', gap: '16px', padding: '10px 0',
    borderBottom: '1px solid #f5f5f5', alignItems: 'center',
  },
  techLayer: { fontSize: '13px', fontWeight: '600', color: '#534AB7', minWidth: '100px' },
  techVal: { fontSize: '13px', color: '#555' },
  devCard: {
  ...
  devAvatar: {
    ...
    background: '#534AB7', color: '#fff', fontSize: '18px', fontWeight: '600',
    display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
  },
  devName: { fontSize: '18px', fontWeight: '600', color: '#1a1a1a', marginBottom: '4px' },
  devDeg: { fontSize: '13px', color: '#534AB7', fontWeight: '500', marginBottom: '2px' },
  devCollege: { fontSize: '13px', color: '#888', marginBottom: '12px' },
  devLinks: { display: 'flex', gap: '16px', flexWrap: 'wrap' },
  devLink: { fontSize: '12px', color: '#534AB7', textDecoration: 'none', fontWeight: '500' },
}
